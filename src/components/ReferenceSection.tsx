...
export function ReferenceSection() {
  ...
  return (
    <section id="references" className="w-full bg-transparent py-40 px-6 relative border-t border-white/5">
      <div className="container mx-auto">
            ...
            {logos.map((logo, i) => (
              ...
              >
                <img 
                  src={logo.src} 
                  alt={logo.alt} 
                  className="h-24 md:h-32 w-auto grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700 drop-shadow-[0_0_20px_rgba(6,182,212,0)] group-hover:drop-shadow-[0_0_20px_rgba(6,182,212,0.3)]" 
                />
              </Link>
            ))}
          </InfiniteSlider>
        ...
        <div className="flex flex-col items-center gap-8">
          <p className="text-2xl text-slate-400 font-light italic text-center max-w-2xl">
            {t.references.subtitle}
          </p>
          <Link to="/projects">
            <Button className="bg-white text-black hover:bg-cyan-500 hover:text-white text-xl px-16 py-10 rounded-full font-black uppercase tracking-widest shadow-2xl transition-all hover:scale-110 group">
